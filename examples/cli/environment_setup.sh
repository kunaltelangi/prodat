...
# This script will show the multiple different ways to setup your environment using prodat

## SCENARIO A: Starting from an uninitialized prodat Project
# Step 1: Initialize the prodat repository with
$ prodat init
...
## SCENARIO B: Adding an environment to an existing prodat Project
# Step 1: begin environment setup with
$ prodat environment setup
# Step 2: Type the number corresponding to the environment you want to use from the list


## SCENARIO C: Adding your own environment to be logged in your prodat Project
# Step 1: begin environment setup with
$ prodat environment setup
