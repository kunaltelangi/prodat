...
from prodat.dashboard.app import app
...
class ProjectCommand(BaseCommand):
    ...
    def init(self, name, description, force):
        ...
        Returns
        -------
        prodat.core.entity.model.Model
        """
        ...
        if environment_setup:
            ...
            self.cli_helper.echo(
                ...
                " here: https://prodat.readthedocs.io/en/latest/env-setup.html")

        return self.project_controller.model

    def version(self):
        return self.cli_helper.echo("prodat version: %s" % __version__)

    def configure(self):
        """
        Configure prodat installation
        """
        ...
        if self.project_controller.model:
            ...
            self.cli_helper.echo(
                "No prodat project found. Skipping configuration for project.")
    ...
    def status(self):
        ...
        if latest_snapshot_user_generated and not latest_snapshot_auto_generated:
            ...
            self.cli_helper.echo("no snapshot autogenerated by prodat")
        elif latest_snapshot_auto_generated and not latest_snapshot_user_generated:
            self.cli_helper.echo("latest snapshot autogenerated by prodat: ")
    ...
    def cleanup(self):
        # Prompt user to ensure they would like to remove prodat information along with environment and files folder
        response = self.cli_helper.prompt_bool(
            __("prompt", "cli.project.cleanup.confirm"))

        # Cleanup prodat project if user specifies
        if response:
    ...
    def dashboard(self):
        if not self.project_controller.is_initialized:
            self.cli_helper.echo(
                "Please initialize prodat before using this command")
            return False
